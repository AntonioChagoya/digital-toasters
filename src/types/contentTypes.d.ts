...
export interface ApiCoffeShopCoffeShop extends Schema.CollectionType {
  collectionName: 'coffe_shops';
  info: {
    singularName: 'coffe-shop';
    pluralName: 'coffe-shops';
    displayName: 'Coffe Shops';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiMenuMenu extends Schema.SingleType {
  ...
  attributes: {
    Menu: Attribute.Component<'global.link', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articles: Attribute.JSON & Attribute.Required;
    users_permissions_user: Attribute.Relation<
      'api::order.order',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    on_delivery: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    fulfilled: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    delivered_date: Attribute.DateTime;
    guide_number: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::order.order',
